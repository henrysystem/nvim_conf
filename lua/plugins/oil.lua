...
return {
  ...
  opts = {
    ...
    -- Keep Oil in sync with external filesystem changes (new files, deletes, renames)
    ...
    keymaps = {
      ...
      ["gm"] = {
        "actions.change_sort",
        opts = { sort = { { "type", "asc" }, { "mtime", "desc" } } },
        desc = "Sort by modified date (newest first)",
      },
      ["gn"] = {
        "actions.change_sort",
        opts = { sort = { { "type", "asc" }, { "name", "asc" } } },
